...
<template>    
    <div>
        ...
        <div class="row" sytle="background-color:cyan; width:900px;">
        ...
        <div class="row">
            <div class="col-left col-3 col-s-3" style="float:left;">             
...
<!-- 
            ...
            <div class="col-right col-9 col-s-9" style="float:left;">
                <div class = "row" style="height:400px;">
                    <div class="col-right-top col-12 col-s-12" style="padding-bottom:10px;">
                ...
                <div class="col-right-bottom row" style="height:500px; overflow:auto;">
                    <div class="col-right-bottom-left col-5 col-s-5">                     
                        <div id="wrapper">
                    ...
                    <div class="col-right-bottom-right col-7 col-s-7"> 
